...
var clientVersion = require('logoran-socket.io-client/package.json').version;
...
Server.prototype.serveClient = function(v){
  ...
  if (v && !clientSource) {
    clientSource = read(resolvePath( 'logoran-socket.io-client/dist/socket.io.js'), 'utf-8');
    try {
      clientSourceMap = read(resolvePath( 'logoran-socket.io-client/dist/socket.io.js.map'), 'utf-8');
    } catch(err) {
...
emitterMethods.concat(['to', 'in', 'use', 'puse', 'send', 'write', 'clients', 'compress']).forEach(function(fn){
